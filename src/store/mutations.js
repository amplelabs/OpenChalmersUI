...
export default {
  ...
  */
  ...
  /**
   * Store user position after fetching browser's location.
   */
  ...
  setUserLocation(state, slots) {
    state.lex.sessionAttributes.intersection = slots.Intersection;
    state.lex.sessionAttributes.useGPS = slots.useGPS;
  },
  setUserLocationFromIp(state, data) {
    state.lex.sessionAttributes.ipLocation = JSON.stringify(
      {
        city: data.city,
        region: data.region,
  ...
  */
  ...
  /**
   * Initialize ChalmersUser in state
   */
  setChalmersUser(state, userId) {
  ...
  setOnboarding(state, stringBoolean) {
    Cookies.set('chalmersOnboarding', stringBoolean, { expires: 3650 })
    state.onboardingComplete = stringBoolean
  },
  setToolTip(state, stringBoolean) {
    Cookies.set('chalmersToolTip', stringBoolean, { expires: 3650 })
    state.toolTipComplete = stringBoolean
  },
  setOnboardingResponse(state, onboardingResponse) {
    state.onboardingResponse = [...state.onboardingResponse, onboardingResponse]
  },
  setAcceptedPolicy(state, boolean) {
    state.acceptedPolicy = boolean
  },
  setGivenEmail(state, stringBoolean) {
    Cookies.set('chalmersEmail', stringBoolean, { expires: 3650 })
    state.givenEmail = stringBoolean
  },
  setSkippedEmail(state, boolean) {
    state.skippedEmail = boolean
  },
  /**
   * Toggle Nav Feedback Dialog
   */
