...
export default {
  ...
  chalmersUser: state => state.chalmersUser,
  feedbackDialog: state => state.feedbackDialog,
  userName: state => state.userName,
  userEmail: state => state.userEmail,
  onboardingComplete: state => state.onboardingComplete,
  toolTipComplete: state => state.toolTipComplete,
  onboardingResponse: state => state.onboardingResponse,
  navDrawer: state => state.navDrawer,
  acceptedPolicy: state => state.acceptedPolicy,
  givenEmail: state => state.givenEmail,
  skippedEmail: state => state.skippedEmail,
  lex: state => state.lex
};
