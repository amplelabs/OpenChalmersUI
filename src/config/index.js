...
const envShortName = ['dev', 'prod', 'staging', 'test'].find(env => process.env.NODE_ENV.startsWith(env));
...
const configDefault = {
  ...
  ui: {
    ...
    textInputPlaceholder: 'Write something here...',

    toolbarColor: '#FF9F1D',

    // chat window title
    toolbarTitle: 'Chalmers',

    // logo used in toolbar - also used as favicon not specificied
    toolbarLogo: "../static/img/Chalmers-logo-Horizontal.svg",
    ...
    // favIcon: '../../static/img/ChalmersBot-logo.png',
    ...
    avatarImageUrl: '/static/img/ChalmersBot.svg',
